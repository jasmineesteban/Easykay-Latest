<?php
    ...
    if(isset($_POST['fare-update'])){
        ...
        $query = "UPDATE `bus_fare` SET `bus_regular`='$updated_regular',`bus_regular_succeeding`='$updated_regular_succ',
                `bus_discounted`='$updated_discounted',`bus_discounted_succeeding`='$updated_discounted_succ ' WHERE 1";
                            
        $res = mysqli_query($conn, $query);
        
        if($res) {
            $message = "You updated the Bus Fare.";
    ...
    $rows = mysqli_query($conn, "SELECT * FROM bus_fare");

    while ($row = mysqli_fetch_assoc($rows)) {
        $regular = $row['bus_regular'];
        $regular_succeeding = $row['bus_regular_succeeding'];
        $discounted = $row['bus_discounted'];
        $discounted_succeeding = $row['bus_discounted_succeeding'];
    }
    ...
    <div class="wrapper">
                    ...
                    <ul class="nav nav-pills flex-column mt-2 mt-sm-0" id="menu">
                        ...
                        <li class="nav-item my-2">
                            ...
                            <ul class="nav collapse ms-4 flex-column" id="faressidemenu" data-bs-parent="#menu">
                                ...
                                <li class="nav-item">
                                    <a href="bus.php" class="nav-link side-active">Bus</a>
                                </li>
                                <li class="nav-item">
        ...
        <div class="containter">
            ...
            <div class="fares">
                    <div class="row">
                        <div class="col-10">
                            <h3 class="title-fare mb-3">Bus' Fare</h3>
                        </div>
                        <div class="col-2 text-center">
                            <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#updateFare">
                    ...
                    <div class="row row-fare mx-auto p-2">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="updateFareLabel">Update Bus Fare</h1>
        ...
        <div class="modal-dialog ">
            <div class="modal-content success-message">
                <div class="modal-body d-flex justify-content-between">
                    <span>Bus fare successfully updated!</span>
                    <button type="button" class="btn-close " data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
