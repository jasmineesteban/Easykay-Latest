<?php
    ...
    if(isset($_POST['archive-btn'])){
        ...
        if ($_SESSION['arcId'] != null) {
            $arcQuery = "SELECT * FROM tb_explore_cultural_religious WHERE cul_id = '$arc_ID'";
    ...
    if (isset($_POST['edit-btn'])) {
        ...
        if ($_SESSION['editId'] != null) {
            $editQuery = "SELECT * FROM tb_explore_cultural_religious WHERE cul_id = '$edit_ID'";
    ...
    if(isset($_POST["search-btn"])){
        ...
        $query = "SELECT cul_id, cul_image, cul_name FROM tb_explore_cultural_religious WHERE cul_name LIKE '%$search%' ORDER BY cul_name ASC";
    }
    else{
        $query = "SELECT cul_id, cul_image, cul_name FROM tb_explore_cultural_religious ORDER BY cul_name ASC";
    }

    $rows = mysqli_query($conn, $query);
    $listArcQuery = "SELECT * FROM `tb_archive_cultural_religious`";
...
<head>
    ...
    <title>Admin | Cultural/Religious Attractions</title>
</head>
<body>
    <div class="wrapper">
                ...
                <div class="sidebar__inner">
                    ...
                    <ul class="nav nav-pills flex-column mt-2 mt-sm-0" id="menu">
                        ...
                        <ul class="nav collapse ms-4 flex-column" id="exploresidemenu" data-bs-parent="#menu">
                            ...
                            <li class="nav-item">
                                <a href="natural_manmade.php" class="nav-link">Natural/Man-Made</a>
                            </li>
                            <li class="nav-item">
                                <a href="cultural.php" class="nav-link side-active">Cultural/Religious</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="containter">
            <div class="col-lg-10 float-end">
                <div class="explore">
                    <div class="row">
                        <div class="col-10">
                            <h3 class="title-attraction mb-3">Cultural/Religious Attractions</h3>
                        </div>
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="item shadow">
                                        <div class="explore-img">
                                            <img class="exp-img" src="../../images/cultural_religious_img/<?php echo $row["cul_image"]; ?>" alt="">
                                        </div>

                                        <?php
                                            $eventTitle = $row["cul_name"]; 
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <div class="actions my-2">
                                                <form action="" method="post" class="frm-btn">
                                                    <input type="hidden" name="edit" value="<?php echo $row["cul_id"]; ?>">
                                                    <button type="submit" class="btn mx-1" name="edit-btn"><i class="fa-solid fa-pen-to-square"></i></button>
                                                </form>
                                                <form action="" method="post" class="frm-btn">
                                                    <input type="hidden" name="archive" value="<?php echo $row["cul_id"]; ?>">
                ...
                <form action="" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group ">
                            <label for="exp_name" class="col col-form-label">Cultural/Religious Attraction Name <span class="required-asterisk">*</span></label>
                            <div class="col-sm-12">
                        ...
                        <div class="form-group my-2">
                            <label for="exp_description" class="col col-form-label">Cultural/Religious Attraction Description <span class="required-asterisk">*</span></label>
                            <div class="col-sm-12">
                        ...
                        <div class="form-group my-2">
                            <label for="exp_location" class="colcol-form-label my-1">Cultural/Religious Attraction Location <span class="required-asterisk">*</span></label>
                            <div class="col-sm-12">
                    ...
                    <div class="modal-footer">
                        <div class="col-4 mx-4">
                            <button type="submit" name="add-cultural" class="btn btn-primary">Add</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="modal fade" id="editmodal" data-bs-backdrop="static" tabindex="-1" aria-labelledby="editmodalLabel" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="addExploreLabel">Edit Cultural/Religious Attraction</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div> 
                <form action="" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                    <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <div class="col-4 mx-4">
                            <button type="submit" name="edit-cultural" class="btn btn-primary">Save</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="" method="POST">
                    ...
                    <div class="modal-footer">
                        <div class="col-4 mx-4">
                            <button type="submit" name="archive-cultural" class="btn btn-primary">Yes</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="modal fade" id="arcsuccessmessage" tabindex="-1" aria-labelledby="arcsuccessmessageLabel" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content success-message">
                <div class="modal-body d-flex justify-content-between">
                    <span>Cultural/Religious attraction successfully archived!</span>
                    <button type="button" class="btn-close " data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                        ...
                        <div class="row shadow-sm my-3 py-2 mx-1">
                            ...
                            <div class="col-4 text-center">
                                <form action="" method="post" class="frm-btn">
                                    ...
                                    <button type="submit" class="btn btn-light fs-6" name="unarchive-cultural-btn"><span class="fw-light text-muted">Unarchive</span></button>
                                </form>
                            </div>
                        </div>
                    <?php endforeach; ?>
    ...
    <?php endif; ?>
     ...
     <div class="modal fade" id="unarcsuccessmessage" tabindex="-1" aria-labelledby="unarcsuccessmessageLabel" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content success-message">
                <div class="modal-body d-flex justify-content-between">
                    <span>Cultural/Religious attraction successfully unarchived!</span>
                    <button type="button" class="btn-close " data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
