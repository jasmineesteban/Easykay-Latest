<?php
    ...
    if(isset($_POST['archive-btn'])){
        ...
        if ($_SESSION['arcId'] != null) {
            $arcQuery = "SELECT * FROM tb_explore_hotel_lodge WHERE hotel_id = '$arc_ID'";
    ...
    if (isset($_POST['edit-btn'])) {
        ...
        if ($_SESSION['editId'] != null) {
            $editQuery = "SELECT * FROM tb_explore_hotel_lodge WHERE hotel_id = '$edit_ID'";
    ...
    if(isset($_POST["search-btn"])){
        ...
        $query = "SELECT hotel_id, hotel_image, hotel_name FROM tb_explore_hotel_lodge WHERE hotel_name LIKE '%$search%' ORDER BY hotel_name ASC";
    }
    else{
        $query = "SELECT hotel_id, hotel_image, hotel_name FROM tb_explore_hotel_lodge ORDER BY hotel_name ASC";
    }

    $rows = mysqli_query($conn, $query);
    $listArcQuery = "SELECT * FROM `tb_archive_hotel_lodge`";
...
<body>
                ...
                <div class="profile mx-4">
                    ...
                    <ul class="nav nav-pills flex-column mt-2 mt-sm-0" id="menu">
                        ...
                        <ul class="nav collapse ms-4 flex-column" id="exploresidemenu" data-bs-parent="#menu">
                            ...
                            <li class="nav-item">
                                <a href="hotel_lodge.php" class="nav-link side-active">Hotel & Lodge</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="containter">
            <div class="col-lg-10 float-end">
                <div class="explore">
                    <div class="row">
                        <div class="col-10">
                            <h3 class="title-attraction mb-3">Hotel & Lodge</h3>
                        </div>
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="item shadow">
                                        <div class="explore-img">
                                            <img class="exp-img" src="../../images/hotel_lodging_img/<?php echo $row["hotel_image"]; ?>" alt="">
                                        </div>

                                        <?php
                                            $eventTitle = $row["hotel_name"]; 
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <div class="actions my-2">
                                                <form action="" method="post" class="frm-btn">
                                                    <input type="hidden" name="edit" value="<?php echo $row["hotel_id"]; ?>">
                                                    <button type="submit" class="btn mx-1" name="edit-btn"><i class="fa-solid fa-pen-to-square"></i></button>
                                                </form>
                                                
                                                <form action="" method="post" class="frm-btn">
                                                    <input type="hidden" name="archive" value="<?php echo $row["hotel_id"]; ?>">
                ...
                <form action="" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group ">
                            <label for="exp_name" class="col col-form-label">Hotel & Lodge Name <span class="required-asterisk">*</span></label>
                            <div class="col-sm-12">
                        ...
                        <div class="form-group my-2">
                            <label for="exp_description" class="col col-form-label">Hotel & Lodge Description <span class="required-asterisk">*</span></label>
                            <div class="col-sm-12">
                        ...
                        <div class="form-group my-2">
                            <label for="exp_location" class="colcol-form-label my-1">Hotel & Lodge Location <span class="required-asterisk">*</span></label>
                            <div class="col-sm-12">
                    ...
                    <div class="modal-footer">
                        <div class="col-4 mx-4">
                            <button type="submit" name="add-hotel" class="btn btn-primary">Add</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="modal fade" id="editmodal" data-bs-backdrop="static" tabindex="-1" aria-labelledby="editmodalLabel" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="addExploreLabel">Edit Hotel & Lodge</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div> 
                <form action="" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                    <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <div class="col-4 mx-4">
                            <button type="submit" name="edit-hotel" class="btn btn-primary">Save</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="" method="POST">
                    ...
                    <div class="modal-footer">
                        <div class="col-4 mx-4">
                            <button type="submit" name="archive-hotel" class="btn btn-primary">Yes</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="modal fade" id="arcsuccessmessage" tabindex="-1" aria-labelledby="arcsuccessmessageLabel" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content success-message">
                <div class="modal-body d-flex justify-content-between">
                    <span>Hotel & Lodge successfully archived!</span>
                    <button type="button" class="btn-close " data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                        ...
                        <div class="row shadow-sm my-3 py-2 mx-1">
                            ...
                            <div class="col-4 text-center">
                                <form action="" method="post" class="frm-btn">
                                    ...
                                    <button type="submit" class="btn btn-light fs-6" name="unarchive-hotel-btn"><span class="fw-light text-muted">Unarchive</span></button>
                                </form>
                            </div>
                        </div>
                    <?php endforeach; ?>
    ...
    <?php endif; ?>
     ...
     <div class="modal fade" id="unarcsuccessmessage" tabindex="-1" aria-labelledby="unarcsuccessmessageLabel" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content success-message">
                <div class="modal-body d-flex justify-content-between">
                    <span>Hotel & Lodge successfully unarchived!</span>
                    <button type="button" class="btn-close " data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
