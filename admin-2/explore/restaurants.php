<?php
    ...
    if(isset($_POST['archive-btn'])){
        ...
        if ($_SESSION['arcId'] != null) {
            $arcQuery = "SELECT * FROM tb_explore_restaurants WHERE resto_id = '$arc_ID'";
    ...
    if (isset($_POST['edit-btn'])) {
        ...
        if ($_SESSION['editId'] != null) {
            $editQuery = "SELECT * FROM tb_explore_restaurants WHERE resto_id = '$edit_ID'";
    ...
    if(isset($_POST["search-btn"])){
        ...
        $query = "SELECT resto_id, resto_image, resto_name FROM tb_explore_restaurants WHERE resto_name LIKE '%$search%' ORDER BY resto_name ASC";
    }
    else{
        $query = "SELECT resto_id, resto_image, resto_name FROM tb_explore_restaurants ORDER BY resto_name ASC";
    }

    $rows = mysqli_query($conn, $query);
    $listArcQuery = "SELECT * FROM `tb_archive_restaurants`";
...
<body>
                ...
                <div class="profile mx-4">
                    ...
                    <ul class="nav nav-pills flex-column mt-2 mt-sm-0" id="menu">
                        ...
                        <ul class="nav collapse ms-4 flex-column" id="exploresidemenu" data-bs-parent="#menu">
                            ...
                            <li class="nav-item">
                                <a href="restaurants.php" class="nav-link side-active">Restaurants</a>
                            </li>
                        </ul>
                        </li>
                        <li class="nav-item my-2">
        ...
        <div class="containter">
            <div class="col-lg-10 float-end">
                <div class="explore">
                    <div class="row">
                    <div class="col-10">
                            <h3 class="title-attraction mb-3">Restaurants</h3>
                        </div>
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="item shadow">
                                        <div class="explore-img">
                                            <img class="exp-img" src="../../images/restaurants_img/<?php echo $row["resto_image"]; ?>" alt="">
                                        </div>

                                        <?php
                                            $eventTitle = $row["resto_name"]; 
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <div class="actions my-2">
                                                <form action="" method="post" class="frm-btn">
                                                    <input type="hidden" name="edit" value="<?php echo $row["resto_id"]; ?>">
                                                    <button type="submit" class="btn mx-1" name="edit-btn"><i class="fa-solid fa-pen-to-square"></i></button>
                                                </form>
                                                
                                                <form action="" method="post" class="frm-btn">
                                                    <input type="hidden" name="archive" value="<?php echo $row["resto_id"]; ?>">
                ...
                <form action="" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group ">
                            <label for="exp_name" class="col col-form-label">Restaurant Name <span class="required-asterisk">*</span></label>
                            <div class="col-sm-12">
                        ...
                        <div class="form-group my-2">
                            <label for="exp_description" class="col col-form-label">Restaurant Description <span class="required-asterisk">*</span></label>
                            <div class="col-sm-12">
                        ...
                        <div class="form-group my-2">
                            <label for="exp_location" class="colcol-form-label my-1">Restaurant Location <span class="required-asterisk">*</span></label>
                            <div class="col-sm-12">
                    ...
                    <div class="modal-footer">
                        <div class="col-4 mx-4">
                            <button type="submit" name="add-restaurant" class="btn btn-primary">Add</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="modal fade" id="editmodal" data-bs-backdrop="static" tabindex="-1" aria-labelledby="editmodalLabel" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="addExploreLabel">Edit Restaurant</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div> 
                <form action="" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                    <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <div class="col-4 mx-4">
                            <button type="submit" name="edit-restaurant" class="btn btn-primary">Save</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="" method="POST">
                    ...
                    <div class="modal-footer">
                        <div class="col-4 mx-4">
                            <button type="submit" name="archive-restaurant" class="btn btn-primary">Yes</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="modal fade" id="arcsuccessmessage" tabindex="-1" aria-labelledby="arcsuccessmessageLabel" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content success-message">
                <div class="modal-body d-flex justify-content-between">
                    <span>Restaurant successfully archived!</span>
                    <button type="button" class="btn-close " data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                        ...
                        <div class="row shadow-sm my-3 py-2 mx-1">
                            ...
                            <div class="col-4 text-center">
                                <form action="" method="post" class="frm-btn">
                                    ...
                                    <button type="submit" class="btn btn-light fs-6" name="unarchive-restaurant-btn"><span class="fw-light text-muted">Unarchive</span></button>
                                </form>
                            </div>
                        </div>
                    <?php endforeach; ?>
    ...
    <?php endif; ?>
     ...
     <div class="modal fade" id="unarcsuccessmessage" tabindex="-1" aria-labelledby="unarcsuccessmessageLabel" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content success-message">
                <div class="modal-body d-flex justify-content-between">
                    <span>Restaurant successfully unarchived!</span>
                    <button type="button" class="btn-close " data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
