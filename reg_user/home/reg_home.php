...
<script>
    ...
    <ul class="dropdown-menu px-1">
        <li><a class="dropdown-item py-1 my-2 btn-active" href="reg_home.php">Home</a></li>
        <li><a class="dropdown-item py-1 my-2" href="../event/reg_event.php">Events</a></li>
        <li><a class="dropdown-item py-1 my-2" href="../explore/resorts.php">Explore</a></li>
        <li><a class="dropdown-item py-1 my-2" href="../profile/profile.php">Profile</a></li>
    </ul>
</div> 
            `;
            return container;
