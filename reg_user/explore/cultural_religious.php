<?php
    ...
    if (isset($_POST['view-btn'])) {
        ...
        if ($_SESSION['viewId'] != null) {
            $viewQuery = "SELECT * FROM `tb_explore_cultural_religious` WHERE cul_id = '$view_ID '";
    ...
    if(isset($_POST["search-btn"])){
        ...
        $query = "SELECT * FROM tb_explore_cultural_religious WHERE cul_name LIKE '%$search%' ORDER BY cul_name ASC";
    }
    else{
        $query = "SELECT * FROM tb_explore_cultural_religious ORDER BY cul_name ASC";
    }
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="natural_manmade.php">Natural/Man-made Attractions</a></li>
                            <li><a class="dropdown-item sub-active" href="cultural_religious.php">Cultural/Religious Attractions</a></li>
        ...
        <div class="explore-row">
            <div class="row mb-4">
                <div class="col-12 col-sm-6 col-lg-6 explore-title">
                    <h5><b>List of Cultural/Religious Attractions</b></h5>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            <div class="explore-img">
                                <img class="img" src="../../images/cultural_religious_img/<?php echo $row["cul_image"]; ?>" alt="">
                            </div>
                        </div>
                        <div class="col-12 col-lg-8">
                            ...
                            <div class="mb-5">
                                <p class="desc"><i class="fa-solid fa-location-dot me-3"></i> <?php echo $row['cul_location']; ?></p>
                            </div>
                            
                            <div class="row">
                                <div class="col-5 mt-4">
                                    <form class="frm" method="post">
                                        <input type="hidden" name="view" value="<?php echo $row["cul_id"]; ?>">
                                ...
                                <div class="col-7 mt-4">
                                    <form class="frm d-flex justify-content-end" method="GET" action="../home/reg_home.php">
                                        <input type="hidden" name="route" value="<?php echo $row["cul_id"]; ?>">
                                        <input type="hidden" name="latitude" value="<?php echo $row["cul_latitude"]; ?>">
                                        <input type="hidden" name="longitude" value="<?php echo $row["cul_longitude"]; ?>">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="explore-img">
                        <img class="img" src="../../images/cultural_religious_img/<?php echo $rowData[5]; ?>" alt="">
                    </div>
                    <div class="mx-1">
                ...
                <div class="modal-footer">
                    <form class="" method="post">
                        <input type="hidden" name="route" value="<?php echo $rowData[0]; ?>">
                        <button class="btn btn-primary show-route" type="submit" name="route-btn">Show Route</button>
                    </form>
                </div>
            </div>
        </div>
