<?php
    ...
    if (isset($_POST['view-btn'])) {
        ...
        if ($_SESSION['viewId'] != null) {
            $viewQuery = "SELECT * FROM `tb_explore_recreational` WHERE rec_id = '$view_ID '";
    ...
    if(isset($_POST["search-btn"])){
        ...
        $query = "SELECT * FROM tb_explore_recreational WHERE rec_name LIKE '%$search%' ORDER BY rec_name ASC";
    }
    else{
        $query = "SELECT * FROM tb_explore_recreational ORDER BY rec_name ASC";
    }
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item sub-active" href="recreational.php">Recreational Facilities</a></li>
        ...
        <div class="explore-row">
            <div class="row mb-4">
                <div class="col-12 col-sm-6 col-lg-6 explore-title">
                    <h5><b>List of Recreational Facilities</b></h5>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            <div class="explore-img">
                                <img class="img" src="../../images/recreational_img/<?php echo $row["rec_image"]; ?>" alt="">
                            </div>
                        </div>
                        <div class="col-12 col-lg-8">
                            ...
                            <div class="mb-5">
                                <p class="desc"><i class="fa-solid fa-location-dot me-3"></i> <?php echo $row['rec_location']; ?></p>
                            </div>
                            
                            <div class="row">
                                <div class="col-5 mt-4">
                                    <form class="frm" method="post">
                                        <input type="hidden" name="view" value="<?php echo $row["rec_id"]; ?>">
                                ...
                                <div class="col-7 mt-4">
                                    <form class="frm d-flex justify-content-end" method="GET" action="../home/reg_home.php">
                                        <input type="hidden" name="route" value="<?php echo $row["rec_id"]; ?>">
                                        <input type="hidden" name="latitude" value="<?php echo $row["rec_latitude"]; ?>">
                                        <input type="hidden" name="longitude" value="<?php echo $row["rec_longitude"]; ?>">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="explore-img">
                        <img class="img" src="../../images/recreational_img/<?php echo $rowData[5]; ?>" alt="">
                    </div>
                    <div class="mx-1">
