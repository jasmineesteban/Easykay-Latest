<?php
    ...
    if (isset($_POST['view-btn'])) {
        ...
        if ($_SESSION['viewId'] != null) {
            $viewQuery = "SELECT * FROM `tb_explore_restaurants` WHERE resto_id = '$view_ID '";
    ...
    if(isset($_POST["search-btn"])){
        ...
        $query = "SELECT * FROM tb_explore_restaurants WHERE resto_name LIKE '%$search%' ORDER BY resto_name ASC";
    }
    else{
        $query = "SELECT * FROM tb_explore_restaurants ORDER BY resto_name ASC";
    }
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item sub-active" href="restaurants.php">Restaurants</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            <div class="explore-img">
                                <img class="img" src="../../images/restaurants_img/<?php echo $row["resto_image"]; ?>" alt="">
                            </div>
                        </div>
                        <div class="col-12 col-lg-8">
                            <div class="content m-4">
                            <?php
                            $title = $row["resto_name"]; 

                            $desc = $row["resto_description"]; 
                            ...
                            <div class="mb-5">
                                <p class="desc"><i class="fa-solid fa-location-dot me-3"></i> <?php echo $row['resto_location']; ?></p>
                            </div>
                            
                            <div class="row">
                                <div class="col-5 mt-4">
                                    <form class="frm" method="post">
                                        <input type="hidden" name="view" value="<?php echo $row["resto_id"]; ?>">
                                ...
                                <div class="col-7 mt-4">
                                    <form class="frm d-flex justify-content-end" method="GET" action="../home/reg_home.php">
                                        <input type="hidden" name="route" value="<?php echo $row["resto_id"]; ?>">
                                        <input type="hidden" name="latitude" value="<?php echo $row["resto_latitude"]; ?>">
                                        <input type="hidden" name="longitude" value="<?php echo $row["resto_longitude"]; ?>">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="explore-img">
                        <img class="img" src="../../images/restaurants_img/<?php echo $rowData[5]; ?>" alt="">
                    </div>
                    <div class="mx-1">
