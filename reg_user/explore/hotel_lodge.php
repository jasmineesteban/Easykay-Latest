<?php
    ...
    if (isset($_POST['view-btn'])) {
        ...
        if ($_SESSION['viewId'] != null) {
            $viewQuery = "SELECT * FROM `tb_explore_hotel_lodge` WHERE hotel_id = '$view_ID '";
    ...
    if(isset($_POST["search-btn"])){
        ...
        $query = "SELECT * FROM tb_explore_hotel_lodge WHERE hotel_name LIKE '%$search%' ORDER BY hotel_name ASC";
    }
    else{
        $query = "SELECT * FROM tb_explore_hotel_lodge ORDER BY hotel_name ASC";
    }
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item sub-active" href="hotel_lodge.php">Hotel & Lodge</a></li>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            <div class="explore-img">
                                <img class="img" src="../../images/hotel_lodging_img/<?php echo $row["hotel_image"]; ?>" alt="">
                            </div>
                        </div>
                        <div class="col-12 col-lg-8">
                            ...
                            <div class="mb-5">
                                <p class="desc"><i class="fa-solid fa-location-dot me-3"></i> <?php echo $row['hotel_location']; ?></p>
                            </div>
                            
                            <div class="row">
                                <div class="col-5 mt-4">
                                    <form class="frm" method="post">
                                        <input type="hidden" name="view" value="<?php echo $row["hotel_id"]; ?>">
                                ...
                                <form class="frm d-flex justify-content-end" method="GET" action="../home/reg_home.php">
                                    <input type="hidden" name="route" value="<?php echo $row["hotel_id"]; ?>">
                                    <input type="hidden" name="latitude" value="<?php echo $row["hotel_latitude"]; ?>">
                                    <input type="hidden" name="longitude" value="<?php echo $row["hotel_longitude"]; ?>">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="explore-img">
                        <img class="img" src="../../images/hotel_lodging_img/<?php echo $rowData[5]; ?>" alt="">
                    </div>
                    <div class="mx-1">
